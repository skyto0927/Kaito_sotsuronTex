...
\begin{figure}[htbp]
    \begin{minipage}{0.2\hsize}
        \begin{center}
            \includegraphics[width=30mm]{up_F0/1_a.png}
        \end{center}
        \caption{一つめの図}
        \label{fig:one}
    \end{minipage}
    \begin{minipage}{0.2\hsize}
        \begin{center}
            \includegraphics[width=30mm]{up_F0/1_i.png}
        \end{center}
        \caption{二つめの図}
        \label{fig:two}
    \end{minipage}
    \begin{minipage}{0.2\hsize}
        \begin{center}
            \includegraphics[width=30mm]{up_F0/1_u.png}
        \end{center}
        \caption{三つめの図}
        \label{fig:three}
    \end{minipage}
    \begin{minipage}{0.2\hsize}
        \begin{center}
            \includegraphics[width=30mm]{up_F0/1_e.png}
        \end{center}
        \caption{4つめの図}
        \label{fig:four}
    \end{minipage}
    \begin{minipage}{0.2\hsize}
        \begin{center}
            \includegraphics[width=30mm]{up_F0/1_o.png}
        \end{center}
        \caption{5つめの図}
        \label{fig:five}
    \end{minipage}
